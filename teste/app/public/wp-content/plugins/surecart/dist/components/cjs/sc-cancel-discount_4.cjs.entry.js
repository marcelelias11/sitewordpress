...
const ScSubscriptionCancel = class {
    ...
    render() {
        return (index.h("sc-dashboard-module", { key: '915e0da3858552d79170106f78eb698b5202ccd6', heading: this.heading || wp.i18n.__('Cancel your plan', 'surecart'), class: "subscription-cancel", error: this.error, style: { '--sc-dashboard-module-spacing': '1em' } }, this.renderContent(), index.h("sc-flex", { key: '036032a82590c922b3167b7b87d3f140d2356dbb', justifyContent: "flex-start" }, index.h("sc-button", { key: 'ad2e297e2cca0db7fc215998cbab017cf19ed0bf', type: "primary", loading: this.loading || this.busy, disabled: this.loading || this.busy, onClick: () => this.cancelSubscription() }, wp.i18n.__('Cancel Plan', 'surecart')), index.h("sc-button", { key: '1ad0cbfe78e8c6664d6507f7cb39e30fc270c6b9', style: { color: 'var(--sc-color-gray-500' }, type: "text", onClick: () => this.scAbandon.emit(), loading: this.loading || this.busy, disabled: this.loading || this.busy }, wp.i18n.__('Keep My Plan', 'surecart'))), this.busy && index.h("sc-block-ui", { key: '2aaa6e5bcde01d056c2edd146d7ddae84426bbd8' })));
    }
};
...
const ScTextarea = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '4248ae2284a2cb8e00caa2c72f136b56afa75bb3', part: "form-control", class: {
                'form-control': true,
                'form-control--small': this.size === 'small',
                'form-control--medium': this.size === 'medium',
                'form-control--large': this.size === 'large',
            } }, index.h("sc-form-control", { key: '450ff72a85f80d390925a283d454f9cbb2d0c7a9', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: 'a2e325cc1836293c9b9e7e1568c0238d0d96bfd9', part: "form-control-input", class: "form-control-input" }, index.h("div", { key: '0bd99c323f098c3858c0be722b354948ae4af40f', part: "base", class: {
                'textarea': true,
            ...
            } }, index.h("textarea", { key: '8998674cdd362594733d093288370f05c188c11d', part: "textarea", ref: el => (this.input = el), id: "input", class: "textarea__control", name: this.name, value: this.value, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, rows: this.rows, minlength: this.minlength, maxlength: this.maxlength, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, enterkeyhint: this.enterkeyhint, inputmode: this.inputmode, "aria-describedby": "help-text", onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur(), onKeyDown: (e) => e.stopPropagation() })), this.showCharLimit && (index.h("div", { key: '3bf51bc2294f5196775dd1d8a840b57ad752b4e4', slot: "help", class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.maxlength && ((_a = this.input) === null || _a === void 0 ? void 0 : _a.value) ? this.maxlength - this.input.value.length : this.maxlength)))))));
    }
